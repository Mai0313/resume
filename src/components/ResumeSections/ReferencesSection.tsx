import type { ReferenceItem } from "@/utils/resumeLoader";
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {visibleReferences?.map((ref, idx) => (
          <ItemCard key={ref.id || `reference-${idx}`}>
            <div className="flex-grow">
              ...
              {ref.description && (
                <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                  <div 
                    className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed italic prose prose-sm dark:prose-invert max-w-none"
